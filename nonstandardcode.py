...
# Function to compute income category proportions
...
# Prepare the housing data for training
...
for mean_score, params in zip(cvres["mean_test_score"], cvres["params"]):
    print("Random Forest with Randomized Search RMSE:", np.sqrt(-mean_score), params)
...
for mean_score, params in zip(cvres["mean_test_score"], cvres["params"]):
    print("Grid Search RMSE:", np.sqrt(-mean_score), params)
